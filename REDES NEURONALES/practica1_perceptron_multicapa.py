...
'''         Perceptron multicapa parametrizable
Desarrollado por: Diego Cardona, Daniel Ramirez y Adriel Machado
Docente: Carlos Sanchez
'''
#--------------------------------------------------------------
import numpy as np
...
#------------ Arreglo de datos -----------------------
X = (np.array([dataset[:, 0], dataset[:, 1], dataset[:, 2], dataset[:, 3], dataset[:, 4], dataset[:, 5]]))#arreglo de datos de entrada
Y = np.array([dataset[:, 6]])#Arreglo de datos de salida
